...
public class AdapterDaftarPo extends BaseAdapter {
    ...
    public AdapterDaftarPo(Activity activity, List<Data> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_row_daftar_po, null);
