...
/**
 * Created by s_idrive on 14-Apr-17.
 */
...
public class AdapterPoProses extends BaseAdapter {
    ...
    public AdapterPoProses(Activity activity, List<Data> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_row_po_proses, null);
